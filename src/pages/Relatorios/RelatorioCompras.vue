<template>
  <div class="text-h5 text-bold">
    <div class="q-py-md">RELATÓRIO DE COMPRAS</div>
    <div class="col-12">
      <div class="row col-2 q-mt-md">
        <q-input class="col-2" label="Código do Produto" outlined dense />
        <q-input class="col-4 q-px-md" label="Fornecedor" outlined dense />
      ...
      <div>
        <q-table
          :columns="this.colunasRelatorioCompras"
          row-key="codigo"
          flat
          bordered
          class="q-mt-lg"
...
import listRelatorioCompras from '../../config/listRelatorioCompras.json'

@Component
export default class ModuleComponent extends Vue {
   // ===== data =====

  colunasRelatorioCompras = listRelatorioCompras.columns
}
</script>
